export default (Api) => {
    return {
        ...
        getOneByQuery:function(params) {
            ...
            params['page'] = 1;
            params['rows'] = 1;
            return Api.get('/projectKeyword/select',params)
        ...
        /**
         * 获取一条projectKeyword记录
         * @param id {number} 用于判断唯一值的ID
         * @return promise
         */
        getOne:function(id) {
            return Api.get(`/projectKeyword/select/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 更新一条projectKeyword记录
         * @param id {number} 用于判断唯一值的ID
         * @param updateInfo {object} 提交信息
         * @return promise
         */
        updateOne:function(id,updateInfo) {
            return Api.post(`/projectKeyword/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条projectKeyword记录
         * @param id {number} 用于判断唯一值的ID
         * @return promise
         */
        deleteOne:function(id) {
            return Api.get(`/projectKeyword/delete/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 创建一条projectKeyword记录
         * @param updateInfo {object} 提交信息
         * @return promise
         */
        createOne:function(updateInfo) {
            return Api.post(`/projectKeyword/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条projectKeyword记录
