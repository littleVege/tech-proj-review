export default (Api) => {
    return {
        ...
        getOneByQuery:function(params) {
            ...
            params['page'] = 1;
            params['rows'] = 1;
            return Api.get('/tdProjectKeyword/select',params)
                .then((data)=> data[1]?data[1][0] || {} : {})
        },
        /**
         * 查询tdProjectKeyword列表
         * @param params {object} 查询条件
        ...
        /**
         * 获取一条tdProjectKeyword记录
         * @param id {number} 用于判断唯一值的ID
         * @return promise
         */
        getOne:function(id) {
            return Api.get(`/tdProjectKeyword/select/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 更新一条tdProjectKeyword记录
         * @param id {number} 用于判断唯一值的ID
         * @param updateInfo {object} 提交信息
         * @return promise
         */
        updateOne:function(id,updateInfo) {
            return Api.post(`/tdProjectKeyword/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条tdProjectKeyword记录
         * @param id {number} 用于判断唯一值的ID
         * @return promise
         */
        deleteOne:function(id) {
            return Api.get(`/tdProjectKeyword/delete/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 创建一条tdProjectKeyword记录
         * @param updateInfo {object} 提交信息
         * @return promise
         */
        createOne:function(updateInfo) {
            return Api.post(`/tdProjectKeyword/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条tdProjectKeyword记录
