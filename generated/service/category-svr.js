export default (Api) => {
    return {
        ...
        getOneByQuery:function(params) {
            ...
            params['page'] = 1;
            params['rows'] = 1;
            return Api.get('/category/select',params)
         ...
         */
        getOne:function(id) {
            return Api.get(`/category/select/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 更新一条category记录
        ...
        updateOne:function(id,updateInfo) {
            return Api.post(`/category/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条category记录
        ...
        createOne:function(updateInfo) {
            return Api.post(`/category/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条category记录
