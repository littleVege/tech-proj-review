export default (Api) => {
    return {
        ...
        getOneByQuery:function(params) {
            ...
            params['page'] = 1;
            params['rows'] = 1;
            return Api.get('/file/select',params)
        ...
        updateOne:function(id,updateInfo) {
            return Api.post(`/file/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条file记录
        ...
        createOne:function(updateInfo) {
            return Api.post(`/file/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条file记录
