export default (Api) => {
    return {
         ...
         */
        getOne:function(id) {
            return Api.get(`/organization/select/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 更新一条organization记录
        ...
        updateOne:function(id,updateInfo) {
            return Api.post(`/organization/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条organization记录
        ...
        deleteOne:function(id) {
            return Api.get(`/organization/delete/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 创建一条organization记录
        ...
        createOne:function(updateInfo) {
            return Api.post(`/organization/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条organization记录
