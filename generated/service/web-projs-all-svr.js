export default (Api) => {
    return {
         ...
         */
        getOne:function(id) {
            return Api.get(`/webProjsAll/select/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 更新一条webProjsAll记录
        ...
        updateOne:function(id,updateInfo) {
            return Api.post(`/webProjsAll/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条webProjsAll记录
        ...
        deleteOne:function(id) {
            return Api.get(`/webProjsAll/delete/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 创建一条webProjsAll记录
        ...
        createOne:function(updateInfo) {
            return Api.post(`/webProjsAll/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条webProjsAll记录
