export default (Api) => {
    return {
        ...
        getOneByQuery:function(params) {
            ...
            params['page'] = 1;
            params['rows'] = 1;
            return Api.get('/importBatch/select',params)
         ...
         */
        getOne:function(id) {
            return Api.get(`/importBatch/select/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 更新一条importBatch记录
        ...
        updateOne:function(id,updateInfo) {
            return Api.post(`/importBatch/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条importBatch记录
        ...
        deleteOne:function(id) {
            return Api.get(`/importBatch/delete/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 创建一条importBatch记录
        ...
        createOne:function(updateInfo) {
            return Api.post(`/importBatch/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条importBatch记录
