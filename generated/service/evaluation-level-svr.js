export default (Api) => {
    return {
        ...
        getOneByQuery:function(params) {
            ...
            params['page'] = 1;
            params['rows'] = 1;
            return Api.get('/evaluationLevel/select',params)
        ...
        /**
         * 获取一条evaluationLevel记录
         * @param id {number} 用于判断唯一值的ID
         * @return promise
         */
        getOne:function(id) {
            return Api.get(`/evaluationLevel/select/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 更新一条evaluationLevel记录
         * @param id {number} 用于判断唯一值的ID
         * @param updateInfo {object} 提交信息
         * @return promise
         */
        updateOne:function(id,updateInfo) {
            return Api.post(`/evaluationLevel/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条evaluationLevel记录
         * @param id {number} 用于判断唯一值的ID
         * @return promise
         */
        deleteOne:function(id) {
            return Api.get(`/evaluationLevel/delete/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 创建一条evaluationLevel记录
         * @param updateInfo {object} 提交信息
         * @return promise
         */
        createOne:function(updateInfo) {
            return Api.post(`/evaluationLevel/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条evaluationLevel记录
