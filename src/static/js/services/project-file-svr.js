export default (Api) => {
    return {
        ...
        getOneByQuery:function(params) {
            ...
            params['page'] = 1;
            params['rows'] = 1;
            return Api.get('/projectFile/select',params)
         ...
         */
        getOne:function(id) {
            return Api.get(`/projectFile/select/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 更新一条projectFile记录
        ...
        updateOne:function(id,updateInfo) {
            return Api.post(`/projectFile/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条projectFile记录
        ...
        deleteOne:function(id) {
            return Api.get(`/projectFile/delete/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 创建一条projectFile记录
        ...
        createOne:function(updateInfo) {
            return Api.post(`/projectFile/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条projectFile记录
