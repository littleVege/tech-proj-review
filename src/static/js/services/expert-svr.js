export default (Api) => {
    return {
         ...
         */
        getOne:function(id) {
            return Api.get(`/expert/select/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 更新一条expert记录
        ...
        updateOne:function(id,updateInfo) {
            return Api.post(`/expert/update/${id}`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 删除一条expert记录
        ...
        deleteOne:function(id) {
            return Api.get(`/expert/delete/${id}`)
                .then((data)=> data[1])
        },
        /**
         * 创建一条expert记录
        ...
        createOne:function(updateInfo) {
            return Api.post(`/expert/insert`,updateInfo)
                .then((data)=> data[1])
        },
        /**
         * 更新或创建一条expert记录
        ...
        queryListByTaskId:function (taskId,page,rows) {
            return Api.get('/expert/selectByTaskOrGroup',{
                taskId:taskId,
                page:page||1,
                rows:rows||10
            })
        },
        queryListByGroupId:function (groupId,page,rows) {
            return Api.get('/expert/selectByTaskOrGroup',{
                groupId:groupId,
                page:page||1,
                rows:rows||10
